...
int main() {
	...
	//ShowWindow(FindWindowA("ConsoleWindowClass", NULL), false); //kanei thn efarmogh na trexei sto background
	// This line is commented out because for some reason an antivirus can detect the program if its running in the background though it can't while its running? lol
