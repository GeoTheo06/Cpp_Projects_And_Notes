...
void apokryptografhsh() {
	...
	char xarakthrasKwdikopoihshs = kryptografhmenoKeimenoChar[0]; //pairnw ton prwto xarakthra apo to kwdikopoihmeno keimeno o opoios einai o xarakthras ths kwdikopoihshs
	...
	for (int i = 0; i < theshDeuterouKenou; i++) {
