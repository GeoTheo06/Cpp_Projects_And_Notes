...
void apokryptografhsh() {
	...
	int additionNumbers[theshDeuterouKenou - 2];
	for (int i = 0; i < theshDeuterouKenou - 2; i++) {
	...
	int w = 0;
	char apokryptografhmenoKeimeno[textLength - (theshDeuterouKenou + 1)];
	int apokryptografhmenoKeimenoInt[textLength - (theshDeuterouKenou + 1)];
	int justTesting;
	int i2 = 0;
