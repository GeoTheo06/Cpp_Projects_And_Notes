...
void meFilo(int arithmosPaiktwn, int pontoiMeFilous, int pontoiSwsthsLekshs, int pontoiLathosLekshs, int prospatheies) { //kane to content twn txt arxeiwn kryptografhmena me +5 (na mhn einai periploko)
