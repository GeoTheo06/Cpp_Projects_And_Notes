...
int playerAttack() { //if I name this just "attack" it will interfere with the variable attack of type float, declared at line 18
	cout << "You have 3 attack choices:" << endl << "1. pepper Spray (P: -5M) (E: -attack * 0.25 = " << geo.attack * 0.25 << ")" << endl << "2. Sword (P: -15M) (E: -" << geo.attack << ")" << endl << "3. Punch the earth so hard that you create a huge crack on the surface and " << name << " dies from fall damage(P: -125M) (E:DEAD)" << endl << endl;
	...
	if (geo.health > 0) {
		...
		cout << "Congratulations! You killed " << name << "! Prepare for the next level..." << endl << endl;
		Sleep(3000);
		playerWin = true;
	}
}
