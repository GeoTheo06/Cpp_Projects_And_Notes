...
class Player { //This class kinda works like storage
	...
	int choiceAttack(float enemyHealth) { //if I name this just "attack" it will interfere with the variable attack of type float, declared at line 18
	...
	int choiceHeal(float playerHealth) {
		mana -= 15;
	}
};
